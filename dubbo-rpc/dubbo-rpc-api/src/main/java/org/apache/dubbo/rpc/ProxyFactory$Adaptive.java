...
public class ProxyFactory$Adaptive implements org.apache.dubbo.rpc.ProxyFactory {
	...
	public java.lang.Object getProxy(org.apache.dubbo.rpc.Invoker arg0) throws org.apache.dubbo.rpc.RpcException {
		...
		try {
			extension = (org.apache.dubbo.rpc.ProxyFactory) ExtensionLoader
			...
			if (count.incrementAndGet() == 1) {
				logger.warn("Failed to find extension named " + extName
								+ " for type org.apache.dubbo.rpc.ProxyFactory, will use default extension javassist instead.",
						e);
			}
			extension = (org.apache.dubbo.rpc.ProxyFactory) ExtensionLoader
					.getExtensionLoader(org.apache.dubbo.rpc.ProxyFactory.class).getExtension("javassist");
		}
